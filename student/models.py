...
class PersonalInfo(models.Model):
    ...
    Program = models.CharField(choices=Program_choice, max_length=45)
    Hall_choice = (
        ('Bangladeshi', 'Bangladeshi'),
        ('Others', 'Others')
    )
    Hall = models.CharField(choices=Hall_choice, max_length=45)
...
class GuardianInfo(models.Model):
    ...
    Name_Of_Mother_Church = models.CharField(max_length=100)
...
class PreviousAcademicInfo(models.Model):
    ...
    Position_roll = models.IntegerField()
